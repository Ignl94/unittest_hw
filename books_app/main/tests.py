...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='Mr. Church').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.biography, 'Bio')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name = 'SciFi').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'SciFi')
    ...
    def test_favorite_book(self):
        ...
        favorited_book = Book.query.get(1)
        self.assertIsNotNone(favorited_book)
        self.assertEqual(favorited_book.title, 'To Kill a Mockingbird')
