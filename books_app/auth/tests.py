...
class AuthTests(TestCase):
    ...
    def test_signup_existing_user(self):
        ...
        response = self.app.post('/signup', post_data)
    ...
    def test_login_correct_password(self):
        ...
        created_user = User(username = 'Sir', password = 'password')
        db.session.add(created_user)
        db.session.commit()
        response = self.app.post('/login',created_user)
        response_text = response.get_data(as_text = True)
    ...
    def test_login_nonexistent_user(self):
        ...
        #   error message
        created_user = User(username='Mr.1', password='password')
        response = self.app.post('/login', created_user)
        response_text = response.get_data(as_text = True)
    ...
    def test_login_incorrect_password(self):
        ...
        #   error message
        create_user()
        response = self.app.post('/login', username='me1',password='donkey')
        response_text = response.get_data(as_text = True)
    ...
    def test_logout(self):
        ...
        create_user()
        self.app.post('/login', username='me1',password='password')
